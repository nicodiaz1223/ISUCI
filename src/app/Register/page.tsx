    ...
    <div className="min-h-screen flex justify-center items-center bg-gray-300">
      <div className="flex w-full max-w-4xl mx-auto bg-white shadow-md">       
        <div className="w-1/2 bg-red-600 p-6 flex flex-col justify-center items-center text-white">
          <h2 className="text-2xl font-bold mb-4">¿Ya tienes cuenta?</h2>
        ...
        <div className="w-1/2 p-6">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-2">
            ...
            <button type="submit" 
            className="w-full py-2 border-2 border-blue-600 text-blue-600 rounded-full inline-block font-bold hover:bg-blue-600 hover:text-white">Registrar
            </button>
          </form>
        </div>
      </div>
